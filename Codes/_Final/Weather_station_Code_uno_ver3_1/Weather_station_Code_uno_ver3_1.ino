...
void lcd_all( )
{
    ...
    if (m%3==0)
    {
        ...
        lcd.setCursor(0,2);
        lcd.print(F("Showing Current datas"));
...
void upload()
{
    ...
    inet.attachGPRS("WAP", "", "");
    char reply_text[8];
    sprintf_P(reply_text,PSTR("hum=%4d"), rhsense);
    numdata=inet.httpPOST("weather.shparvez.net", 80, "/Add/hum.php", reply_text ,msg, 50);
    ...
    int pres=floor(presf);
   // char reply_text[9];
    sprintf_P(reply_text,PSTR("baro=%4d"), pres);
    numdata=inet.httpPOST("weather.shparvez.net", 80, "/Add/baro.php", reply_text ,msg, 50);



    inet.attachGPRS("WAP", "", "");
    //char reply_text[9];
    sprintf_P(reply_text,PSTR("wind=%4d"), rp4s);
    numdata=inet.httpPOST("weather.shparvez.net", 80, "/Add/wind.php", reply_text ,msg, 50);

    inet.attachGPRS("WAP", "", "");
    //char reply_text[9];
    sprintf_P(reply_text,PSTR("rain=%4d"), count2);
    numdata=inet.httpPOST("weather.shparvez.net", 80, "/Add/rain.php", reply_text ,msg, 50);
...
/* need to delete this comment
    ...
    sprintf_P(reply_text,PSTR("Rain:  %3d mm ,\nWind Speed: %3d kmph ,\nHumidity: %3d percent\nTemparature: %3d C\n Pressure: %4d kPa"),count2_r, speedskmph_r, rh_r, tempc_r, preskPa_r);
