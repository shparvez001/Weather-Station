...
inet.attachGPRS("WAP", "", "");
  ...
  sprintf_P(reply_text,PSTR("hum=%4d"), analog2);

 //numdata=inet.httpPOST("weather.shparvez.net", 80, "/Add/hum.php", reply_text2 ,msg2, 50);
inet.httpPOST2("weather.shparvez.net", 80, "/Add/hum.php", reply_text );
...
// numdata=inet.httpPOST("weather.shparvez.net", 80, "/Add/temp.php", reply_text ,msg, 50);
 inet.httpPOST2("weather.shparvez.net", 80, "/Add/temp.php", reply_text);
...
inet.httpPOST2("weather.shparvez.net", 80, "/Add/baro.php", reply_text);
...
inet.httpPOST2("weather.shparvez.net", 80, "/Add/wind.php", reply_text);
...
inet.httpPOST2("weather.shparvez.net", 80, "/Add/rain.php", reply_text);
